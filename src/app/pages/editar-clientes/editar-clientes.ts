...
export class EditarClientes {
  ...
  ngOnInit() {
    ...
    this.http.get('https://apiclientes-sergio-fjdhc0bsf5fke9ey.canadacentral-01.azurewebsites.net/api/v1/clientes/' + id)
  ...
  atualizarCliente() {
    ...
    this.http.put('https://apiclientes-sergio-fjdhc0bsf5fke9ey.canadacentral-01.azurewebsites.net/api/v1/clientes/' + this.id, this.formulario.value, { responseType: 'text' })
