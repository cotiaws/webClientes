...
export class ConsultarClientes {
  ...
  consultarClientes() {    
      ...
      this.http.get('https://apiclientes-sergio-fjdhc0bsf5fke9ey.canadacentral-01.azurewebsites.net/api/v1/clientes?nome=' + this.formulario.value.nome)
  ...
  excluirCliente(id: string) {
    if(confirm('Deseja realmente excluir esse cliente?')) {
      ...
      this.http.delete('https://apiclientes-sergio-fjdhc0bsf5fke9ey.canadacentral-01.azurewebsites.net/api/v1/clientes/' + id, { responseType: 'text' })
